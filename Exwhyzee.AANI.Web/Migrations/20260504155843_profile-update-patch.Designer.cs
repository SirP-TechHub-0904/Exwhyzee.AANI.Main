...
namespace Exwhyzee.AANI.Web.Migrations
{
    ...
    [Migration("20260504155843_profile-update-patch")]
    partial class profileupdatepatch
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Exwhyzee.AANI.Domain.Models.BirthdayMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("RecipientParticipantId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Exwhyzee.AANI.Domain.Models.BirthdayTemplate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Exwhyzee.AANI.Domain.Models.Chapter", b =>
                {
                    ...
                    b.Property<string>("MonnifyAccountName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MonnifyAccountNumber")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MonnifyBankName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Exwhyzee.AANI.Domain.Models.Committee", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Exwhyzee.AANI.Domain.Models.CommitteeMember", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Exwhyzee.AANI.Domain.Models.FundCategory", b =>
                {
                    ...
                    b.Property<decimal>("ChapterShare")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<bool>("IsNationalLevel")
                        .HasColumnType("bit");

                    b.Property<decimal>("NationalShare")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Exwhyzee.AANI.Domain.Models.MessageTemplate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Exwhyzee.AANI.Domain.Models.NameTitle", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Exwhyzee.AANI.Domain.Models.Participant", b =>
                {
                    ...
                    b.Property<bool>("DisableTitleInIDName")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("FontSizeInIdName")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IDCardDownloaded")
                        .HasColumnType("bit");

                    b.Property<DateTime?>("IdCardDownloadedAt")
                        .HasColumnType("datetime2");

                    b.Property<string>("IdDigit")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("IsMonotorGeneral")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Exwhyzee.AANI.Domain.Models.CommitteeMember", b =>
                {
                    b.HasOne("Exwhyzee.AANI.Domain.Models.Committee", "Committee")
                        .WithMany("Members")
