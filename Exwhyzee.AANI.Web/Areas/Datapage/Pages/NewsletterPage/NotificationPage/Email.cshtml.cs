...
namespace Exwhyzee.AANI.Web.Areas.Datapage.Pages.NewsletterPage.NotificationPage
{
    public class EmailModel : PageModel
    {
        ...
        public EmailModel(AaniDbContext context, UserManager<Participant> userManager, IRecipientParser recipientParser, ITemplateRenderer templateRenderer)
        {
            _context = context;
        ...
        public async Task OnGetAsync()
        {
            TemplateList = await _context.MessageTemplates
                .Where(t => t.IsActive && t.MessageType == MessageType.Email)
        ...
        // AJAX: return templates for messageType (keeps signature similar for reuse)
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                TempData["warning"] = "subject is required for email";
                return RedirectToPage();
            }
            ...
            foreach (var rec in dedup)
            {
                ...
                {
                    skipped.Add($"{rec.fullName} (no email)");
                    continue;
                }
            ...
            TempData["success"] = $"Sent {createdCount} email notifications. Skipped: {skipped.Count}";
            if (skipped.Any())
            {
